...
class _TrackStateAppState extends State<TrackStateApp>
  ...
  Future<void> _switchToHostedRepository({
    ...
    final nextRepository = await _openHostedRepository(
        ...
        return MaterialApp(
          ...
          home: !_workspaceProfilesReady
              ...
              ? _WorkspaceOnboardingScreen(
                  ...
                  loadHostedRepositories: viewModel.canBrowseHostedRepositories
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          final condensedDesktop =
              !compact &&
              constraints.maxWidth < (canOpenWorkspaceOnboarding ? 1220 : 1080);
