...
void main() {
  test(
    'hosted startup fallback keeps the interactive shell unblocked while deferred auth runs',
    () async {
      ...
      expect(
        ...
        isFalse,
        reason:
            'The interactive shell must not be blocked once the hosted startup fallback snapshot is published, even while deferred auth is still running.',
      );
    },
  );
}
