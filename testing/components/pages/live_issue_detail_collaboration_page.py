...
class LiveIssueDetailCollaborationPage:
    ...
    def ensure_connected(
        ...
        *,
        ...
        if self._session.count(
            ...
            has_text=TrackStateTrackerPage.CONNECT_BUTTON_TEXT,
        ) == 0:
        ...
        if wait_match.matched_text not in connected_banners:
            raise AssertionError(
                ...
                "connected state required for TS-396.\n"
    ...
    def _is_connected(self, connected_banners: tuple[str, ...]) -> bool:
        return (
            ...
            or any(
                connected_banner in self.current_body_text()
                for connected_banner in connected_banners
            )
        )
