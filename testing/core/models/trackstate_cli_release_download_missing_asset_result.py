...
class TrackStateCliReleaseDownloadMissingAssetRepositoryState:
...
@dataclass(frozen=True)
class TrackStateCliReleaseDownloadMissingAssetValidationResult:
    initial_state: TrackStateCliReleaseDownloadMissingAssetRepositoryState
    final_state: TrackStateCliReleaseDownloadMissingAssetRepositoryState
