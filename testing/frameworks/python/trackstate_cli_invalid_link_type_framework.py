...
from testing.core.models.trackstate_cli_invalid_link_type_result import (
    TrackStateCliInvalidLinkTypeObservation,
...
class PythonTrackStateCliInvalidLinkTypeFramework(
    PythonTrackStateCliCompiledLocalFramework,
    TrackStateCliInvalidLinkTypeProbe,
):
        ...
        *,
        ...
        with tempfile.TemporaryDirectory(
            ...
            with tempfile.TemporaryDirectory(
                ...
                invalid_link_observation = self._observe_command(
                    requested_command=config.invalid_link_command(str(repository_path)),
                    repository_path=repository_path,
                    executable_path=executable_path,
                    fallback_reason=fallback_reason,
                )
                return TrackStateCliInvalidLinkTypeValidationResult(
                    observation=TrackStateCliInvalidLinkTypeObservation(
                        ...
                        invalid_link_observation=invalid_link_observation,
