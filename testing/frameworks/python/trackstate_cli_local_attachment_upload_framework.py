...
class PythonTrackStateCliLocalAttachmentUploadFramework(
    PythonTrackStateCliCompiledLocalFramework,
    TrackStateCliLocalAttachmentUploadProbe,
):
    ...
    def observe_local_attachment_upload(
        ...
        *,
        ...
        with tempfile.TemporaryDirectory(prefix="trackstate-ts-381-bin-") as bin_dir:
            executable_path = Path(bin_dir) / "trackstate"
            self._compile_executable(executable_path)
            with tempfile.TemporaryDirectory(prefix="trackstate-ts-381-repo-") as temp_dir:
                ...
                return TrackStateCliLocalAttachmentUploadValidationResult(
        ...
        *,
        ...
        return TrackStateCliCommandObservation(
            ...
            fallback_reason=(
                ...
                "so TS-381 can run the exact ticket command from the seeded repository "
...
TS-381 local attachment upload fixture.
""",
        )
        ...
        self._git(repository_path, "config", "--local", "user.name", "TS-381 Tester")
        self._git(
            repository_path,
            "config",
            "--local",
        ...
        self._git(repository_path, "commit", "-m", "Seed TS-381 fixture")
    ...
    def _capture_repository_state(
        ...
        *,
        ...
        return TrackStateCliLocalAttachmentUploadRepositoryState(
