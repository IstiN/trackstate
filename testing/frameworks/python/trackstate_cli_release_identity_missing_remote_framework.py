...
class PythonTrackStateCliReleaseIdentityMissingRemoteFramework(
    PythonTrackStateCliCompiledLocalFramework,
    TrackStateCliReleaseIdentityMissingRemoteProbe,
):
        ...
        *,
        ...
        with tempfile.TemporaryDirectory(prefix="trackstate-ts-523-bin-") as bin_dir:
            ...
            with tempfile.TemporaryDirectory(prefix="trackstate-ts-523-repo-") as temp_dir:
                ...
                return TrackStateCliReleaseIdentityMissingRemoteValidationResult(
...
""",
    ...
    def _capture_repository_state(
        ...
        *,
        ...
        return TrackStateCliReleaseIdentityMissingRemoteRepositoryState(
