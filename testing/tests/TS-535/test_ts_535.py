...
def _write_pass_outputs(result: dict[str, object]) -> None:
    ...
    jira_lines = [
        ...
        "",
        "h4. What was tested",
        "* Compiled the TrackState CLI from the repository {{main}} snapshot to run the deployed implementation instead of the stale test branch checkout.",
