...
5. records any restore-specific blocked-window diagnostics observed while the
...
```text
Pass: after the busy-state release, the prepared active local workspace restores
as the selected Local Git row without keeping Hosted setup workspace active or
