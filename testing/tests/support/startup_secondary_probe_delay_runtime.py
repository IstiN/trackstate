...
@dataclass
class StartupSecondaryProbeObservation:
    repository: str
...
class StartupSecondaryProbeDelayRuntime(StoredWorkspaceProfilesRuntime):
    def __init__(
        self,
        *,
        repository: str,
        ...
        observation: StartupSecondaryProbeObservation,
    ...
    def __enter__(self):
        ...
        if self._context is None:
            raise RuntimeError(
                "StartupSecondaryProbeDelayRuntime expected a browser context.",
            )
    ...
    @property
    def observation(self) -> StartupSecondaryProbeObservation:
        ...
        try:
            ...
            with self._delay_lock:
                ...
                if self._pending_auth_requests == 0:
                    self._observation.auth_probe_released_at_monotonic = (
                        time.monotonic()
                    )
...
Ts1002SecondaryProbeObservation = StartupSecondaryProbeObservation
Ts1002SecondaryProbeDelayRuntime = StartupSecondaryProbeDelayRuntime
