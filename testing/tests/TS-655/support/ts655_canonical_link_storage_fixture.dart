...
class Ts655CanonicalLinkStorageFixture {
  Ts655CanonicalLinkStorageFixture._(this.directory)
  ...
  String get validLinksJsonContent =>
      '${jsonEncode(<Map<String, String>>[validLinkRecord])}\n';

  static Future<Ts655CanonicalLinkStorageFixture> create() async {
    final directory = await Directory.systemTemp.createTemp(
      'trackstate-ts-655-',
    );
    final fixture = Ts655CanonicalLinkStorageFixture._(directory);
  ...
  Future<Ts655RepositoryObservation> observeRepositoryState() async {
    ...
    final linksFileContent = linksFileExists
        ...
        : null;
    return Ts655RepositoryObservation(
      repositoryPath: repositoryPath,
  ...
  Future<Ts655StorageAttemptObservation> attemptCanonicalLinksWrite() async {
    ...
    return Ts655StorageAttemptObservation(
      branch: writeResult.branch,
      attemptedPath: sourceLinksPath,
      attemptedContent: validLinksJsonContent,
  ...
  Future<void> _seedRepository() async {
    ...
    await _git(<String>[
      'commit',
      '-m',
      'Seed canonical link fixture for TS-655',
    ]);
  }
...
class Ts655RepositoryObservation {
  const Ts655RepositoryObservation({
...
class Ts655StorageAttemptObservation {
  const Ts655StorageAttemptObservation({
  ...
  final Ts655RepositoryObservation afterObservation;
}
