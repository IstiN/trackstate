...
class TrackStateCliReadTicketInwardSymmetricLinkTest(unittest.TestCase):
    maxDiff = None

    def setUp(self) -> None:
        self.repository_root = Path(__file__).resolve().parents[3]
        self.config = TrackStateCliReadTicketInwardSymmetricLinkConfig.from_defaults()
    ...
    def test_read_ticket_returns_canonical_inward_symmetric_link_metadata(self) -> None:
        ...
        self._assert_command_was_executed_exactly(
            ...
            precondition_message=(
                "Precondition failed: TS-670 must create Issue A in the disposable "
        ...
        self._assert_command_was_executed_exactly(
            ...
            precondition_message=(
                "Precondition failed: TS-670 must create Issue B in the disposable "
                "Local Git repository before reading the linked target issue."
            ),
        )
        self._assert_command_was_executed_exactly(
            ...
            precondition_message=(
                "Precondition failed: TS-670 must create the symmetric `relates to` "
        ...
        self._assert_command_was_executed_exactly(
            ...
            precondition_message=(
                "Step 1 failed: TS-670 must execute the exact `trackstate read "
    ...
    def _assert_command_was_executed_exactly(
        ...
        *,
        ...
        self.assertIsNotNone(
            ...
            f"{precondition_message}\n"
            "TS-670 must execute a repository-local compiled binary so the seeded "
        ...
        self.assertEqual(
            ...
            observation.compiled_binary_path,
            f"{precondition_message}\n"
            "TS-670 did not run the compiled repository-local CLI binary.\n"
            f"Executed command: {observation.executed_command_text}\n"
