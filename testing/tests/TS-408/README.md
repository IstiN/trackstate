...
The save verification waits up to 60 seconds for the hosted field catalog to
repopulate so the test catches real post-save persistence failures instead of
asserting too early.
