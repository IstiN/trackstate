...
class KebabCaseCliSearchPaginationShapeTest(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_kebab_case_flags_return_flattened_pagination_fields(self) -> None:
        ...
        self.assertEqual(
            ticket_data,
            control_data,
            "Expected result failed: the kebab-case flag aliases did not produce the "
            "same flattened `data` payload as the camelCase control command.\n"
            f"Observed kebab-case data: {ticket_data}\n"
            f"Observed camelCase data: {control_data}",
        )
        self.assertNotIn(
            "page",
            ticket_data,
            "Expected result failed: the response still nested pagination fields "
            "inside `data.page` for the kebab-case alias path.\n"
        ...
        for fragment in (
            ...
            self.assertIn(
                ...
                "not show the expected flattened pagination fields for the kebab-case "
                "command.\n"
        ...
        self.assertNotIn(
            ...
            "showed a nested `page` object for the kebab-case command.\n"
            f"Observed stdout:\n{output}",
        )
    ...
    def _assert_successful_search_observation(
        ...
        *,
        ...
        self.assertEqual(
            ...
            expected_command,
            f"{failure_prefix}: the wrong command was executed for the TS-339 "
            "scenario.\n"
        ...
        self.assertIsNotNone(
            ...
            f"{failure_prefix}: TS-339 must execute a repository-local compiled "
        ...
        self.assertEqual(
            ...
            observation.compiled_binary_path,
            f"{failure_prefix}: TS-339 did not run the compiled repository-local "
            "CLI binary.\n"
            f"Executed command: {observation.executed_command_text}\n"
        ...
        self.assertFalse(
            ...
            "flattened Jira-compatible pagination keys required by TS-339.\n"
