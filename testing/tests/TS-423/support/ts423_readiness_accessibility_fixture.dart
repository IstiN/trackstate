...
class Ts423ReadinessAccessibilityFixture {
  Ts423ReadinessAccessibilityFixture._({required this.repository});

  static const Duration initialSearchDelay = Duration(seconds: 5);
  static const String issueKey = 'TRACK-423';
  static const String issueSummary =
      'Expose accessible loading feedback for readiness states';
  static const String issueDescription =
      'The issue detail body should stay hidden until detail hydration finishes.';

  final Ts423ReadinessAccessibilityRepository repository;

  static Future<Ts423ReadinessAccessibilityFixture> create() async {
    final repository = Ts423ReadinessAccessibilityRepository(
      _createHostedRepository(),
      initialSearchDelay: initialSearchDelay,
    );
    return Ts423ReadinessAccessibilityFixture._(repository: repository);
  }
}
...
String _shaFor(String path) {
  return switch (path) {
    ...
    '/repos/$_repositoryName/contents/TRACK/.trackstate/index/issues.json' =>
      'index-sha',
    '/repos/$_repositoryName/contents/TRACK/TRACK-423/main.md' => 'issue-sha',
    _ => 'sha',
  };
}

const String _repositoryName = 'octo/ts423-readiness-accessibility';
...
const _treeResponse = {
  'tree': [
    ...
    {'path': 'TRACK/TRACK-423/main.md', 'type': 'blob'},
  ],
};

const _contentResponses = {
  '/repos/octo/ts423-readiness-accessibility/contents/TRACK/project.json':
      '{"key":"TRACK","name":"Readiness Accessibility Demo","defaultLocale":"en"}',
  '/repos/octo/ts423-readiness-accessibility/contents/TRACK/config/statuses.json':
      '[{"id":"todo","name":"To Do"},{"id":"in-progress","name":"In Progress"},{"id":"done","name":"Done"}]',
  '/repos/octo/ts423-readiness-accessibility/contents/TRACK/config/issue-types.json':
      '[{"id":"story","name":"Story"}]',
  '/repos/octo/ts423-readiness-accessibility/contents/TRACK/config/fields.json':
      '[{"id":"summary","name":"Summary"},{"id":"description","name":"Description","type":"markdown","reserved":true}]',
  '/repos/octo/ts423-readiness-accessibility/contents/TRACK/config/priorities.json':
      '[{"id":"high","name":"High"}]',
  '/repos/octo/ts423-readiness-accessibility/contents/TRACK/config/workflows.json':
  ...
  '/repos/octo/ts423-readiness-accessibility/contents/TRACK/.trackstate/index/issues.json':
      '[{"key":"TRACK-423","path":"TRACK/TRACK-423/main.md","parent":null,"epic":null,"parentPath":null,"epicPath":null,"summary":"Expose accessible loading feedback for readiness states","issueType":"story","status":"in-progress","priority":"high","assignee":"qa-user","labels":["accessibility","loading"],"updated":"2026-05-12T06:00:00Z","children":[],"archived":false}]',
  '/repos/octo/ts423-readiness-accessibility/contents/TRACK/TRACK-423/main.md':
      '---\nkey: TRACK-423\nproject: TRACK\nissueType: story\nstatus: in-progress\npriority: high\nsummary: Expose accessible loading feedback for readiness states\nassignee: qa-user\nreporter: qa-user\nlabels:\n  - accessibility\n  - loading\nupdated: 2026-05-12T06:00:00Z\n---\n\n# Description\n\nThe issue detail body should stay hidden until detail hydration finishes.\n',
};

class Ts423ReadinessAccessibilityRepository
    implements TrackStateRepository, ProjectSettingsRepository {
  Ts423ReadinessAccessibilityRepository(
    this._delegate, {
    ...
    return TrackerSnapshot(
      ...
      readiness: const TrackerBootstrapReadiness(
        domainStates: <TrackerDataDomain, TrackerLoadState>{
          ...
          TrackerDataDomain.issueSummaries: TrackerLoadState.loading,
        ...
        sectionStates: <TrackerSectionKey, TrackerLoadState>{
          TrackerSectionKey.dashboard: TrackerLoadState.loading,
          TrackerSectionKey.board: TrackerLoadState.loading,
  ...
  Future<TrackerSnapshot> saveProjectSettings(ProjectSettingsCatalog settings) {
    ...
    throw StateError(
      'TS-423 readiness accessibility repository does not support project settings.',
    );
  }
}
