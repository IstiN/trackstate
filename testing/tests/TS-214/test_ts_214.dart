...
void main() {
  ...
  test('TS-214 creates a new issue without mutating the legacy deleted index', () async {
    final fixture = await Ts214LegacyDeletedIndexCreateFixture.create();
    addTearDown(fixture.dispose);

    final beforeCreate = await fixture.observeBeforeCreateState();
    ...
    expect(
      beforeCreate.activeIssueSearchResults.map((issue) => issue.key).toList(),
    ...
    final afterCreate = await fixture.createIssueViaRepositoryService(
