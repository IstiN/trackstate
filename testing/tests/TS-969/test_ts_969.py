...
def main() -> None:
    ...
    try:
        ...
        result["wrapper_exit_code"] = _extract_exit_code(
            wrapper_step_output or full_run_log_text
        )
...
def _evaluate_wrapper_exit_code(
    ...
    *,
    ...
    step_failures: list[str] = []
    exit_code = _extract_exit_code(full_run_log_text)
    ...
    if exit_code != "1":
        step_failures.append(
            "the wrapper did not report `Process completed with exit code 1` in the hosted log; "
    ...
    *,
    ...
    _record_human_verification(
        ...
        observed=(
            ...
            f"exit code: `{_extract_exit_code(wrapper_step_output or full_run_log_text) or '<none>'}`; "
