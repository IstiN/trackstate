...
class TrackStateCliInvalidLinkTypeTest(unittest.TestCase):
    maxDiff = None

    def setUp(self) -> None:
        self.repository_root = Path(__file__).resolve().parents[3]
        self.config = TrackStateCliInvalidLinkTypeConfig.from_defaults()
    ...
    def test_invalid_link_type_returns_controlled_error_response(self) -> None:
        ...
        self._assert_command_was_executed_exactly(
            ...
            precondition_message=(
                "Precondition failed: TS-645 must create Issue A in the disposable "
        ...
        self._assert_command_was_executed_exactly(
            ...
            precondition_message=(
                "Precondition failed: TS-645 must create Issue B in the disposable "
                "Local Git repository before attempting the invalid link mutation."
            ),
        )
        self._assert_command_was_executed_exactly(
            ...
            precondition_message=(
                "Step 1 failed: TS-645 must execute the exact invalid link command "
        ...
        self.assertEqual(
            ...
            "Expected result failed: the CLI did not return the descriptive "
            "unsupported-link-type message required by the ticket.\n"
    ...
    def _assert_command_was_executed_exactly(
        ...
        *,
        ...
        self.assertIsNotNone(
            ...
            f"{precondition_message}\n"
            "TS-645 must execute a repository-local compiled binary so the seeded "
        ...
        self.assertEqual(
            ...
            observation.compiled_binary_path,
            f"{precondition_message}\n"
            "TS-645 did not run the compiled repository-local CLI binary.\n"
            f"Executed command: {observation.executed_command_text}\n"
