...
class TrackStateCliInverseLinkCanonicalPayloadTest(unittest.TestCase):
    maxDiff = None
    ...
    def test_inverse_link_label_returns_canonical_relationship_metadata(self) -> None:
        ...
        self._assert_command_was_executed_exactly(
            ...
            precondition_message=(
                "Precondition failed: TS-629 must create Issue A in the disposable "
        ...
        self._assert_command_was_executed_exactly(
            ...
            precondition_message=(
                "Precondition failed: TS-629 must create Issue B in the disposable "
                "Local Git repository before attempting the inverse link."
            ),
        )
        self._assert_command_was_executed_exactly(
            ...
            precondition_message=(
                "Step 1 failed: TS-629 must execute the exact inverse-label link "
        ...
        self.assertEqual(
            ...
            "ticket-link",
            "Step 2 failed: the inverse-link CLI response did not report the "
        ...
        self.assertEqual(
            ...
            "Expected result failed: the visible CLI response payload did not "
            "rewrite the inverse label into canonical relationship metadata.\n"
        ...
        self.assertEqual(
            ...
            self.config.issue_a_key,
            "Expected result failed: the visible CLI response should still be "
            "anchored to Issue A after returning canonical relationship metadata.\n"
    ...
    def _assert_command_was_executed_exactly(
        ...
        *,
        ...
        self.assertIsNotNone(
            ...
            f"{precondition_message}\n"
            "TS-629 must execute a repository-local compiled binary so the seeded "
        ...
        self.assertEqual(
            ...
            observation.compiled_binary_path,
            f"{precondition_message}\n"
            "TS-629 did not run the compiled repository-local CLI binary.\n"
            f"Executed command: {observation.executed_command_text}\n"
